...
$$ \dfrac{dv_{o}}{dt}|_{max} = \dfrac{-19.947 \ V}{-43.719\ \mu s} = 0.456 \frac{V}{\mu s} $$
  ...
  The circuit diagram shown below was simulated with AC analysis to determine the gain-bandwidth product(GBW) of the op amp.  
   ...
   Fig 4 shows the measurements from the AC analysis of the circuit. 
    $$ BW \simeq f_{H} $$
    $$ GB = |A_{G}|BW $$
...
Fig 6 shows the result of the DC analysis of the circuit in Fig 5. Hence that the DC differential gain is
$$A_{d} = 206.505 \frac{V}{mV} $$    
    ...
    \captionof{figure}{}    
    \end{minipage}\\   
Fig 7 shows the result of the DC analysis and hence the offset Voltage can be determined to be:
$$ V_{OS} = 1.147 mV $$\\
...
Diffrence between theoretical and simulated values of the $\mu A741$ op amp can be seen in table 1.\\
...
\begin{enumerate}
  ...
  \\
	\begin{minipage}{\linewidth}
        ...
        \captionof{figure}{Transient analysis the circuit in the last figure.}  
    \end{minipage}
  ...
  \item[$\bold{3.}$]
  	...
  	\begin{minipage}{\linewidth}
        ...
        \captionof{figure}{Now with the capacitor value as $1mF$}
    \end{minipage}
    \vspace{1em}
