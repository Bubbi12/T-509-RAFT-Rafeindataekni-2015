...
\pagebreak
  ...
  \begin{figure}[h!]
        \centering
        \includegraphics[width=8cm]{fig1-3-fl.png}
  ...
  \begin{figure}[h!]
        \centering
        \includegraphics[width=8cm]{fig1-3-R-in-multisim.png}
        \captionof{figure}{The circuit with added signal resistance.}
  \end{figure}

  \begin{figure}[h!]
        \centering
        \includegraphics[width=8cm]{fig1-3-R-in.png}
...
\begin{figure}[h!]
        \centering
        \includegraphics[width=8cm]{fig1-3-R-out-multisim.png}
        \captionof{figure}{The circuit with added signal resistance.}
  \end{figure}

  \begin{figure}[h!]
        \centering
        \includegraphics[width=8cm]{fig1-3-R-out.png}
        \captionof{figure}{The AC analysis used to find the new gain with input resistance.}
  \end{figure}
