...
\subsection*{1.2}
  ...
  Calculations from the high frequency analysis using a small signal hybrid-pi model show that $$f_{H} = 2.918MHz$$
...
\pagebreak
  ...
  \begin{figure}[h!]
        ...
        \captionof{figure}{The AC analysis used to find the gain and f$_{H}$}
  \end{figure}

  \begin{figure}[h!]
        \centering
        \includegraphics[width=12cm]{fig1-3-fl.png}
        \captionof{figure}{The AC analysis used to find f$_{L}$}
  \end{figure}
