...
\end{table}%
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=12cm]{circuit_task_2.jpg}
...
From figure 5 the midband gain $$A_1 = -15.95 \frac{V}{V} = 24.05 dB $$
...
\begin{figure}[h!]
\includegraphics[scale = 0.23]{theoretical_task2_1.jpg}
\end{figure}
